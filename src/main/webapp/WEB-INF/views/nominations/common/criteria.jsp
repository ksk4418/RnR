									...
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion"
												href="#collapseTwo">Criteria To Qualify</a> <span
													...
													<tbody>
														<tr role="row">
															...
															<td><textarea rows="7" cols="50"
																	name="nomLine1Text1"></textarea></td>
															<td>30%</td>
															<td><input type="number" class="width30px"
																name="nomLine1Text2" /></td>
														</tr>
														<tr role="row">
															<td>2</td>
															...
															<td><textarea rows="6" cols="50"
																	name="nomLine2Text1"></textarea></td>
															<td>30%</td>
															<td><input type="number" class="width30px"
																name="nomLine2Text2" /></td>
														</tr>
														<tr role="row">
															<td>3</td>
															<td><b>Client Satisfaction:</b></td>
															<td><textarea rows="3" cols="50"
																	name="nomLine3Text1"></textarea></td>
															<td>30%</td>
															<td><input type="number" class="width30px"
																name="nomLine3Text2" /></td>
														</tr>
														<tr role="row">
															<td>4</td>
															<td><b>Other Noteworthy Achievements:</b></td>
															<td><textarea rows="3" cols="50"
																	name="nomLine4Text1"></textarea></td>
															<td>10%</td>
															<td><input type="number" class="width30px"
																name="nomLine4Text2" /></td>
														</tr>
													</tbody>
												</table>
