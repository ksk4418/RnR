...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getHierarchy",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<jsp:include page="../../commonPages/header.jsp"></jsp:include>
	<jsp:include page="../../commonPages/navigationMenu.jsp"></jsp:include>
		<section class="cgi-rnr-main-content">
			<div class="container">
				<div class="row">
				<h4 align="Center">Hierarchy</h4>
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="displayName" data-identifier="true">Display Name</th>
			            <th data-column-id="id">Hierarchy Id</th>
			            <th data-column-id="name">Name</th>
			            <th data-column-id="columnName">Column Name</th>
			        </tr>
			    </thead>
			</table>
<!-- 		</div> -->
