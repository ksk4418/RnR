...
<script lang="text/javascript">
   $( document ).ready(function(e)
   {
       ...
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getNominationPhase",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="name" data-identifier="true">Nomination_Phase Name</th>
			            <th data-column-id="id">Nomination_Phase Id</th>
			            <th data-column-id="phase">Phase</th>
