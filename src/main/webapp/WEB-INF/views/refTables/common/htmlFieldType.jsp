...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getHTMLFieldType",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="filedName" data-identifier="true">Field Name</th>
			            <th data-column-id="id">Field Id</th>
			            <th data-column-id="fieldContent">Content</th>
			            <th data-column-id="versionNumber">Version</th>
			        </tr>
			    </thead>
			</table>
<!-- 		</div> -->
