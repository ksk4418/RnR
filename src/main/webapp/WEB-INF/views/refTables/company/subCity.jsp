...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getSubCity",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="subCityName" data-identifier="true">Sub_City Name</th>
			            <th data-column-id="subCityID">Sub_City Id</th>
			            <th data-column-id="subCityDisplayName">Display Name</th>
