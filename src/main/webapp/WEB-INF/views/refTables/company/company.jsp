...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getCompany",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="companyName" data-identifier="true">Company Name</th>
			            <th data-column-id="companyID">Company Id</th>
			            <th data-column-id="companyDisplayName">Display Name</th>
			            <th data-column-id="companyStartDate">Start Date</th>
			        </tr>
			    </thead>
			</table>
<!-- 		</div> -->
