...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getState",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="stateName" data-identifier="true">State Name</th>
			            <th data-column-id="stateID">State Id</th>
			            <th data-column-id="stateDisplayName">Display Name</th>
