...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getCity",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
//            }
       }).on("selected.rs.jquery.bootgrid", function(e, rows)
       {
           ...
           document.getElementById("cityID").value = rows[0].id;
	    ...
	    dialog = $( "#dialog-form" ).dialog({
	        ...
	        buttons: {
	          "Insert": function() {
	        	  ...
	        	  textBox.value =document.getElementById("cityID").value;
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="cityName" data-identifier="true">City Name</th>
			            <th data-column-id="cityID">City Id</th>
			            <th data-column-id="cityDisplayName">Display Name</th>
...
<div id="dialog-form" title="Add new City">
  <form>
    <fieldset>
      ...
      <input type="text" name="cid" id="cityID" class="text ui-widget-content ui-corner-all">
      <label for="cName">City Name</label>
      <input type="text" name="cName" id="cName" value="" class="text ui-widget-content ui-corner-all">
      <label for="cdName">Display Name</label>
      <input type="text" name="cdName" id="cdName" value="" class="text ui-widget-content ui-corner-all">
