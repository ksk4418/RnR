...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getProject",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="projectName" data-identifier="true">Project Name</th>
			            <th data-column-id="projectId">Project Id</th>
			            <th data-column-id="projectDesc">Description</th>
			            <th data-column-id="activeFI">Frequency</th>
			        </tr>
			    </thead>
			</table>
<!-- 		</div> -->
