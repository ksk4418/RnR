...
//        document.getElementById("delete").disabled = true;
       $("#grid-keep-selection").bootgrid({
           ...
           url: "http://localhost:8080/rnr/getVertical",
           selection: true,
           multiSelect: false,
           rowSelect: true,
           keepSelection: true
...
<!-- 		<div class="col-sm-9 main" role="main"> -->
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
			    <thead>
			        <tr>
			            <th data-column-id="vericalName" data-identifier="true">Vertical Name</th>
			            <th data-column-id="verticalId">Vertical Id</th>
			            <th data-column-id="activeFl">Frequency</th>
			            <th data-column-id="verticalDesc">Description</th>
			        </tr>
			    </thead>
			</table>
<!-- 		</div> -->
