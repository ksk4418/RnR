    ...
    <fieldset>
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
		        ...
		        <tr>
					...
					<td><input type="text" name="panelNamee" id="panelNamee" class="text ui-widget-content ui-corner-all"></td>
		        ...
		        <tr>
					...
					<td><input type="text" name="tresholde" id="tresholde" class="text ui-widget-content ui-corner-all"></td>
    ...
    <fieldset>
			<table id="grid-keep-selection" class="table table-condensed table-hover table-striped">
		        ...
		        <tr>
					...
					<td><input type="text" name="panelNamed" id="panelNamed" class="text ui-widget-content ui-corner-all"></td>
		        	<td><label for="panelDescriptiond">Panel Desc.</label></td>
		        	<td><input type="text" name="panelDescriptiond" id="panelDescriptiond" class="text ui-widget-content ui-corner-all" ></td>
		        </tr>
		        <tr>
		        	<td><label for="autoGenerated">Auto Generate</label></td>
		        	<td><input type="checkbox" name="autoGenerated" id="autoGenerated" class="text ui-widget-content ui-corner-all" ></td>
		        	<td><label for="minExpRequiredd">Experience required in CGI</label></td>
		        	<td>
		        		<select id="minExpRequiredd" name="minExpRequiredd">
		        			<option value=0>0 months</option>
		        			<option value=1>6 months</option>
		        			<option value=12>12 months</option>
		        			<option value=18>18 months</option>
		        ...
		        <tr>
					...
					<td><input type="text" name="tresholdd" id="tresholdd" class="text ui-widget-content ui-corner-all"></td>
		        	<td><label for="titleGroupd">Title Group</label></td>
		        	<td>
		        		<select id="titleGroupd" name="titleGroupd">
		        			<option value=1>Title Group 1</option>
		        			<option value=2>Title Group 2</option>
		        			<option value=3>Title Group 3</option>
		        			<option value=4>Title Group 4</option>
